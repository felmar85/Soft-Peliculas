...
<div id="seccion-categoria">
    <div class="box-header">
        <i class="fa fa-building" aria-hidden="true">Gestion de Categorias</i>
        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" id="fcategoria">


                    <div class="form-group">
                            <label class="control-label col-sm-2" for="id_categoria">Codigo:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="id_categoria" name="id_categoria" placeholder="Ingrese codigo" value="" data-validation="length alphanumeric" data-validation-length="3-12" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nombre_categoria" name="nombre_categoria"
                                    placeholder="Ingrese Nombre de la categoria" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="button" id="actualizar" data-toggle="tooltip" title="Actualizar categoria"
